function calcShipping(sum, min, shipping) {
    ...
    if (productsSum == 0 || productsSum >= freeShippingMinSum) {
        shippingSum = 0; // если productsSum равно 0, или, если productsSum Больше или равна freeShippingMinSum, то shippingSum присвоить значение 0
...
function calcDiscount(sum, min, discount) {
    ...
    // создайте переменную discountPrice, если productsSum больше или равно discountMinSum,
    // то присвойте discountSum значение discountPart процентов от productsSum, иначе присвойте discountSum значение 0 
